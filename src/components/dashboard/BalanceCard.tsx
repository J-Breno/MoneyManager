...
const BalanceCard: React.FC<BalanceCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-r from-[#c300ff] to-[#d64fff] rounded-2xl p-6 shadow-lg"
    >
      <div className="flex items-center justify-between mb-6">
        ...
        >
          {isBalanceVisible ? <EyeOff size={20} className="text-white" /> : <Eye size={20} className="text-white" />}
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <motion.div
          ...
          className="bg-white bg-opacity-25 rounded-xl p-4"
        >
          <div className="flex items-center space-x-2 text-[#00ff37] mb-2">
            <TrendingUp size={16} />
        ...
        <motion.div
          ...
          className="bg-white bg-opacity-25 rounded-xl p-4"
        >
          <div className="flex items-center space-x-2 text-[#ff0000] mb-2">
